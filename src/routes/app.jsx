    ...
    <>
      <div className="w-10/12 max-w-6xl m-auto bg-[#0D1117] min-h-dvh flex flex-col">
        <div className="flex justify-between items-center">
          <Link
            to={"/"}
            className="text-xl md:text-3xl font-bold cursor-pointer mt-2 text-gray-300"
          >
            faizan
          </Link>
          <div className="flex gap-2 md:gap-4 items-center mt-2">
            ...
            >
              <svg
                ...
                width="24"
                viewBox="0 0 512 512"
                className="duration-150 ease-in-out fill-gray-300 hover:fill-gray-300/70"
              >
        ...
        <div className="mt-16 lg:mt-12 flex flex-1 flex-col justify-center items-start lg:flex-row lg:justify-between lg:items-center">
          ...
          <div className="mt-16 lg:mt-0 grid grid-cols-2 lg:grid-cols-1 justify-between gap-6 w-full lg:w-1/4 lg:text-right">
            <div className="flex flex-col gap-4">
              <NavLink
                className={({ isActive }) =>
                  `w-max lg:self-end text-base md:text-xl font-medium duration-300 underline decoration-sky-500 underline-offset-8 hover:text-sky-500 ${
            ...
            <div className="text-right flex flex-col gap-4 border-r-2 border-sky-500 px-4 pb-1">
              <p className="text-sm md:text-base font-semibold text-[#a1a1a1]">
                projects
              </p>
              <div className="flex flex-col gap-4 text-right">
                <NavLink
                  className={({ isActive }) =>
                    `w-max self-end text-sm md:text-base underline decoration-sky-500 underline-offset-8 duration-300 hover:text-sky-500 ' ${
                      isActive ? "text-sky-500" : "text-gray-300"
                    }`
                  }
                  to={"/projects/quizmaster"}
                >
                  Quiz Master
                </NavLink>
                <NavLink
