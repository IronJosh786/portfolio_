  ...
  return (
    <>
      <div className='w-10/12 max-w-6xl m-auto bg-[#1d1d20] h-dvh flex flex-col'>
          ...
          <div className='mt-16 lg:mt-0 flex flex-col justify-between gap-8 lg:w-1/4'>
            <div className="flex flex-col gap-8">
              ...
              <ul className='flex flex-col gap-4 border-t-2 border-l-2 border-pink-700 rounded-lg p-4'>
                ...
                <NavLink className={({isActive}) => `text-sm md:text-base underline decoration-pink-700 underline-offset-8 duration-500 ease-in-out tracking-tighter hover:tracking-wide hover:text-pink-700' ${isActive ? 'text-pink-700' : 'text-white'}`} to={'/CurrencyConverter'}>Currency Converter</NavLink>
                <NavLink className={({isActive}) => `text-sm md:text-base underline decoration-pink-700 underline-offset-8 duration-500 ease-in-out tracking-tighter hover:tracking-wide hover:text-pink-700' ${isActive ? 'text-pink-700' : 'text-white'}`} to={'/SimonGame'}>Simon Game</NavLink>
              </ul>
            </div>
        ...
        <footer className='tracking-wider p-1 mt-8 text-xs text-center'>FAIZAN SHAIKH © 2024</footer>
      </div>
    </>
  );
};
